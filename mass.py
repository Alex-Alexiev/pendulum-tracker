...
def plot_period_vs_amplitude():
    ...
    plt.errorbar(amp_all, periods, yerr=T_error, xerr=pos_err, errorevery=5, ecolor="red", alpha=0.5)
    plt.ylim((2, 3))
    ...
    plt.ylim((2, 3))
    plt.text(0.2, 0.6, "y = 2.47 - 0.008*x + 0.15*x^2", transform=ax.transAxes)
